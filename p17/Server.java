...
public class Server {
    public static void main(String[] args) throws IOException
    {
        ...
        // 创建线程池，负责处理通信管道的任务(最后第三个参数表示：缓存8个任务)
        ThreadPoolExecutor pool = new ThreadPoolExecutor(16 * 2, 16 * 2, 0, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(8), Executors.defaultThreadFactory(), new ThreadPoolExecutor.AbortPolicy());
        ...
        while (true) {
            ...
            // 无论有多少个客户端连接，都是用pool中固定的32个线程来处理任务。
